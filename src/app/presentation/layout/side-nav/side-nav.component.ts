 ...
 * Injecte LOCAL_SETTINGS_PORT (abstraction domain) — jamais LocalSettingsAdapter directement.
 */
@Component({
...
export class SideNavComponent {
  private readonly settings = inject<LocalSettingsRepository>(LOCAL_SETTINGS_PORT);
